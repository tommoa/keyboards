...
[_QWERTY] = LAYOUT_preonic_grid(
  ...
  LALT_T(KC_ESC), LGUI_T(KC_A), KC_S,    KC_D,    KC_F,   KC_G,    KC_H,    KC_J,   KC_K,    KC_L,    LGUI_T(KC_SCLN), KC_QUOT,
...
[_COLEMAK] = LAYOUT_preonic_grid(
  KC_GRV,         KC_1,         KC_2,    KC_3,    KC_4,  KC_5,    KC_6,    KC_7, KC_8,    KC_9,    KC_0,         KC_BSPC,
  KC_TAB,         KC_Q,         KC_W,    KC_F,    KC_P,  KC_G,    KC_J,    KC_L, KC_U,    KC_Y,    KC_SCLN,      RGUI_T(KC_DEL),
  LALT_T(KC_ESC), LGUI_T(KC_A), KC_R,    KC_S,    KC_T,  KC_D,    KC_H,    KC_N, KC_E,    KC_I,    LGUI_T(KC_O), KC_QUOT,
...
[_LOWER] = LAYOUT_preonic_grid(
  ...
  KC_DEL,  _______, _______, KC_LPRN, KC_RPRN, _______, _______, KC_UNDS,   KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE,
