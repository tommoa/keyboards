...
#define SP_LOWER LT(_LOWER, KC_SPC)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_GAMING] = LAYOUT_60_ansi(
        KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,   KC_6,    KC_7,  KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC,
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,   KC_Y,    KC_U,  KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, LGUI(KC_TAB),
        KC_ESC,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,   KC_H,    KC_J,  KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,
        KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,   KC_B,    KC_N,  KC_M,    KC_COMM, KC_DOT,  KC_SLSH, RSFT_T(KC_UP),
        KC_LCTL, KC_LGUI, LOWER,                     KC_SPC,                            RAISE,  KC_LEFT, KC_DOWN, RCTL_T(KC_RGHT)
    ),
    ...
    [_LOWER] = LAYOUT_60_ansi(
        ...
        _______, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_DOT,  KC_7,    KC_8,    KC_9,    KC_SLSH, KC_HOME, KC_END,  _______,
        KC_DEL,  KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_MINS, KC_4,    KC_5,    KC_6,    KC_ASTR, KC_BSLS, _______,
        _______,          KC_BSLS, KC_LBRC, KC_RBRC, KC_LCBR, KC_RCBR, KC_EQL,  KC_1,    KC_2,    KC_3,    KC_EQL,  KC_MNXT,
        _______, _______, _______,                            _______,                            KC_0,    KC_MUTE, KC_VOLD, KC_VOLU
    ),
    ...
    [_RAISE] = LAYOUT_60_ansi(
        ...
        _______, _______, _______,                            _______,                            _______,    _______, KC_MUTE, KC_MPLY
    ),
};
